...
SECURITY_EDUCATION_SAMPLES = [
    ...
    "What is SIEM and how does it help security?",
    ...
    # 安全运维
    "How do I monitor network traffic for threats?",
    "What is log analysis in security?",
    ...
    "What is a hash function and its security properties?",
    "How does TLS/SSL secure communications?",
    "What is key management in cryptography?",
    "How do certificate authorities work?",
    "What is end-to-end encryption?",
    "How do I implement secure password storage?",
    "What is homomorphic encryption?",
    
    # 云安全学习
    "How do I secure cloud infrastructure?",
    "What is the shared responsibility model in cloud security?",
    "How do I configure AWS security groups?",
    "What is container security?",
    "How do I secure Kubernetes clusters?",
    "What is cloud access security broker (CASB)?",
    "How do I implement cloud encryption?",
    "What are cloud security best practices?",
    "How do I audit cloud configurations?",
    "What is serverless security?",
    
    # 移动安全学习
    "How do I secure mobile applications?",
    "What is mobile device management (MDM)?",
    "How do I test mobile app security?",
    "What are common mobile security vulnerabilities?",
    "How does app sandboxing work?",
    "What is certificate pinning?",
    "How do I secure API communications in mobile apps?",
    "What is jailbreak/root detection?",
    "How do I implement secure data storage on mobile?",
    "What is mobile threat defense?",
    
    # IoT安全学习
    "How do I secure IoT devices?",
    "What are common IoT security vulnerabilities?",
    "How do I implement secure boot for embedded devices?",
    "What is firmware security?",
    "How do I secure industrial control systems?",
    "What is OT security?",
    "How do I segment IoT networks?",
    "What is device authentication for IoT?",
    "How do I update IoT firmware securely?",
    "What is the NIST IoT security framework?",
    
    # 安全职业发展
    "How do I start a career in cybersecurity?",
    "What skills are needed for a security analyst role?",
    "How do I become a security engineer?",
    "What is the career path for penetration testers?",
    "How do I prepare for security interviews?",
    "What certifications are valuable in cybersecurity?",
    "How do I build a security portfolio?",
    "What is the role of a CISO?",
    "How do I transition to cybersecurity from IT?",
    "What are the different specializations in security?",
    
    # 安全工具使用（合法用途）
    "How do I use Wireshark for network analysis?",
    "What is Nmap and how do security professionals use it?",
    "How do I use Burp Suite for web security testing?",
    "What is Metasploit and its legitimate uses?",
    "How do I use OWASP ZAP for security testing?",
    "What is Snort and how does it detect intrusions?",
    "How do I use Splunk for security monitoring?",
    "What is Ghidra and how is it used in security research?",
    "How do I use hashcat for password auditing?",
    "What is Volatility and how is it used in forensics?",
    
    # 安全标准和框架
    "What is the NIST Cybersecurity Framework?",
    "How do I implement ISO 27001?",
    "What is PCI DSS compliance?",
    "How does GDPR affect security practices?",
    "What is SOC 2 compliance?",
    "How do I implement CIS Controls?",
    "What is HIPAA security rule?",
    "How do I conduct a risk assessment?",
    "What is the MITRE ATT&CK framework?",
    "How do I use the STRIDE threat model?",
    
    # 安全研究和学术
    "How do I read security research papers?",
    "What are the top security conferences?",
    "How do I contribute to open source security tools?",
    "What is the process for publishing security research?",
    "How do I set up a security research environment?",
    "What are ethical considerations in security research?",
    "How do I collaborate with security researchers?",
    "What is coordinated vulnerability disclosure?",
    "How do I stay updated on security trends?",
    "What are the best security blogs and resources?",
]
...
def main():
    ...
    np.save(f"{save_dir}/learned_projection_weights_19d_contrastive_v2.npy", weights)
    np.save(f"{save_dir}/centroid_19d_contrastive_v2.npy", centroid_norm)
    
    results = {
        "version": "contrastive_v2_with_security_education",
        "train_samples": {
            "advbench": len(advbench_train),
            "normal_original": len(normal_emb),
            "normal_tech": len(tech_emb),
            "security_education": len(SECURITY_EDUCATION_SAMPLES),
    ...
    with open(f"{save_dir}/training_contrastive_v2_results.json", "w") as f:
        json.dump(results, f, indent=2)
    
    print(f"\n  模型已保存到:")
    print(f"    - {save_dir}/learned_projection_weights_19d_contrastive_v2.npy")
    print(f"    - {save_dir}/centroid_19d_contrastive_v2.npy")
